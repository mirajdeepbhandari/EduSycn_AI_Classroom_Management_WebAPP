...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2025 at 07:58 PM
...
(9096, 'Ram Bhandari', '9841214461', '$2b$12$v6hlzcqvGkiPm4VK106fL.TeCg7MdhXYANH0GIJ3NyuHAhuGJVwsm', 'Ram@gmail.com', 'teacher', 'approved'),
(9098, 'ganesh tamang', '9841214421', '$2b$12$L2328Je1QeBkxJK/yPorROkrYotMycVrBfxNYy/UovsGRgcNDYgOy', 'ganesh@gmail.com', 'student', 'approved'),
(9100, 'Milan Bhandari', '9841214411', '$2b$12$Q.SA95K7YDR/RLMYwosMW.2UMqdrggrTRViJwBH4zo8Lo54IvtI96', 'Milan@gmail.com', 'teacher', 'approved');
...
--
ALTER TABLE `teacher`
  MODIFY `teacher_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9903;
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9101;
